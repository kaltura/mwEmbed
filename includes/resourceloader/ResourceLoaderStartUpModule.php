...
class ResourceLoaderStartUpModule extends ResourceLoaderModule {
	...
	public function getScript( ResourceLoaderContext $context ) {
		global $IP, $wgScriptPath, $wgLoadScript, $wgLegacyJavaScriptGlobals, $wgBaseMwEmbedPath;

		$out = file_get_contents( "$wgBaseMwEmbedPath/resources/startup.js" );
	...
	public function getModifiedTime( ResourceLoaderContext $context ) {
		global $IP, $wgScriptPath, $wgCacheEpoch, $wgBaseMwEmbedPath;
		...
		$this->modifiedTime[$hash] = filemtime( "$wgBaseMwEmbedPath/resources/startup.js" );
