...
$uiVars = array(
	'services' => array(
		...
		'vars' => array(
			...
			'strings.k-no-flash-installed' => array(
            					'type' => 'String',
            					'desc' => 'No Flash installed message for IE8 users. This Flashvar can be used only through mw.setConfig(). For example: mw.setConfig( \'strings.k-no-flash-installed\' , \'Flash Player nėra įdiegtas jūsų kompiuteryje\' ); Please Note: IE8 has problems parsing utf-8 characters, so in order to translate the message please save the HTML file with UTF-8 encoding and add META tag to the HEAD of the HTML page: &lt;META http-equiv=Content-Type content=\'text/html; charset=utf-8\'&gt;',
