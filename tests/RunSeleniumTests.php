...
require( dirname( __FILE__ ) . '/selenium_framework/Maintenance.php' );
...
//UNUSED require_once 'Testing/Selenium.php';
//UNUSED require_once 'PHPUnit/Framework.php';
require_once( 'PHPUnit/Extensions/SeleniumTestCase.php' );
include_once( 'PHPUnit/Util/Log/JUnit.php' );

require_once( dirname( __FILE__ ) . "/selenium_framework/Selenium.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumConfig.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumLoader.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumServerManager.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumTestCase.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumTestConsoleLogger.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumTestConstants.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumTestHTMLLogger.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumTestListener.php" );
require_once( dirname( __FILE__ ) . "/selenium_framework/SeleniumTestSuite.php" );
