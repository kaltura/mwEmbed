...
require_once( "$IP/selenium_framework/includes/Exception.php" );
wfInstallExceptionHandler();
wfProfileOut( $fname . '-exception' );

wfProfileIn( $fname . '-includes' );
require_once( "$IP/selenium_framework/includes/GlobalFunctions.php" );
require_once( "$IP/selenium_framework/includes/Hooks.php" );
require_once( "$IP/selenium_framework/includes/Namespace.php" );
require_once( "$IP/selenium_framework/includes/ProxyTools.php" );
require_once( "$IP/selenium_framework/includes/ObjectCache.php" );
require_once( "$IP/selenium_framework/includes/ImageFunctions.php" );
