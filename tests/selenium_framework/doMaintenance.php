...
if ( file_exists( "$IP/StartProfiler.php" ) ) {
	...
	require_once( "$IP/selenium_framework/includes/ProfilerStub.php" );
}

// Some other requires
require_once( "$IP/selenium_framework/includes/AutoLoader.php" );
require_once( "$IP/selenium_framework/includes/Defines.php" );
require_once( "$IP/selenium_framework/includes/DefaultSettings.php" );
...
// Some last includes
require_once( "$IP/selenium_framework/includes/Setup.php" );
