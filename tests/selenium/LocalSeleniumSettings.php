...
$wgSeleniumTestsWikiUrl = 'http://prototype.wikimedia.org/test.1';
...
$wgSeleniumTestsWikiUser      = 'test-user';
$wgSeleniumTestsWikiPassword  = 'test-password';
...
$wgSeleniumTestsBrowsers['firefox']   = 'Safari on OS X Snow Leopard';
