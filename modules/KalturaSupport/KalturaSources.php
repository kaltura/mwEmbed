...
class KalturaSources{
	...
	public function getSources(){
		...
		$isAccessControlAllowed = $this->getEntryResult()->isAccessControlAllowed();
		if( ! $isAccessControlAllowed ) {
			return $this->fatalError( $isAccessControlAllowed );
			return array();
		}

		$kResultObject = $this->getEntryResult();
	...
	private function getReferer() {
		if( isset($_GET['referrer']) ) {
			...
			return base64_encode( $this->getEntryResult()->request->getReferer() );
		}
	}
	public function getSourceForUserAgent(){

		// Get user agent
		$userAgent = $this->getEntryResult()->request->getUserAgent();
	 ...
	 */
	public static function getErrorVideoSources( $errorType ){
