...
return array(
	'comscorestreamingtag' => array(
		'description' => "Supports sending player analytics events to comScoreStreamingTag.",
		'label' => "comScoreStreamingTag",
		'attributes'=> array(
			'cTagsMap'=>array(
				'doc' => "URL to a comScoreStreamingTag XML tag mapping file.",
				'label' => 'ComscoreStreamingTag XML tag mapping file path',
				'type' => 'url',
			),
