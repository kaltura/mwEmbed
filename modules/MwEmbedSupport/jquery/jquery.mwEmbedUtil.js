...
( function ( $ ) {
	...
	$.btnHtml = function ( msg, styleClass, iconId, opt ) {
		...
		var targetAttr = ( opt.target ) ? ' target="' + opt.target + '" ' : '';
		var styleAttr = ( opt.style ) ? ' style="' + opt.style + '" ' : '';
	...
	$.button = function ( originalOptions ) {
		var options = $.extend( {}, defaultButtonOptions, originalOptions );
