	...
	'widevine' => array(
		...
		'attributes' => array(
			...
			'useSupportedDeviceTitle' => array(
				'doc' => "Will override the default title of the message that is shown when trying to play Widevine content in an unsupported device",
				'type' => 'string'
			),
			'intallFlashMsg' => array(
				'doc' => "Will override the message that will prompt the user to install Flash",
				'type' => 'string'
			),
			'installFlashTitle' => array(
				'doc' => "Will override the title of the message that will prompt the user to install Flash",
				'type' => 'string'
			),
			'useKdpMsg' => array(
				'doc' => "Will override the message that will prompt the user to use KDP",
				'type' => 'string'
			),
			'useKdpTitle' => array(
				'doc' => "Will override the title of the message that will prompt the user to use KDP",
				'type' => 'string'
			),
			'promptStyle' => array(
