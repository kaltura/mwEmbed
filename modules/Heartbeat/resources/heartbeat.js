...
( function( mw, $ ) {
    ...
    mw.PluginManager.add( 'heartbeat', mw.KBasePlugin.extend({
        ...
        trackPlay: function(){
            if( this.getPlayer().sequenceProxy === undefined || ( this.getPlayer().sequenceProxy && !this.getPlayer().sequenceProxy.isInSequence ) ){// don't send trackPlay if the player plays an ad
