...
( function( mw, $ ) { "use strict";
	...
	mw.setDefaultConfig( {
		...
		// If the player is in an iframe and acting as an api server
		'EmbedPlayer.IsIframeServer' : false
