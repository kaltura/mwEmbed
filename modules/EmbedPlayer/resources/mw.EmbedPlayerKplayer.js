...
<<<<<<< Updated upstream
			var srcUrl = window.kWidgetSupport.getBaseFlavorUrl(this.kpartnerid);
			if (this.streamerType === 'hdnetworkmanifest') {
				srcUrl = srcUrl.replace("https", "http");
			}
			srcUrl += "/entryId/" + this.kentryid + flavorIdParam
=======
