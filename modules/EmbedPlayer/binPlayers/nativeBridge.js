(function (mw, $) {
	...
	NativeBridge.videoPlayer = NativeBridge.videoPlayer || {
		...
		playerMethods: [ 
			...
			'doneFSBtnPressed', 'addNativeAirPlayButton', 'showNativeAirPlayButton', 'hideNativeAirPlayButton', 'doNativeAction', 'textTracksReceived', 'loadEmbeddedCaptions', 'flavorsListChanged', 'switchFlavor', 'seek', 'seeked' ],
