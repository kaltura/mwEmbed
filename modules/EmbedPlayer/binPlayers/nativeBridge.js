...
NativeBridge.videoPlayer = NativeBridge.videoPlayer  || {
	...
	playerMethods: [ 'stop', 'play', 'pause', 'setPlayerSource', 'bindPlayerEvents', 'showNativePlayer', 'hideNativePlayer', 'toggleFullscreen', 'notifyKPlayerEvent', 'notifyKPlayerEvaluated', 'notifyJsReady', 'doneFSBtnPressed' ],
